...
<liferay-ui:icon-menu>
	<c:if
		test="<%= permissionChecker.hasPermission(groupId, name, manufacturerId, ActionKeys.UPDATE) %>">
		<portlet:renderURL var="editURL">
			<portlet:param name="mvcPath"
				value="/html/manufacturer/edit_manufacturer.jsp" />
			<portlet:param name="manufacturerId"
				value="<%= String.valueOf(manufacturerId) %>" />
	...
	<c:if
		test="<%= permissionChecker.hasPermission(groupId, name, manufacturerId, ActionKeys.DELETE) %>">
	...
	<c:if
		test="<%= permissionChecker.hasPermission(groupId, name, manufacturerId, ActionKeys.PERMISSIONS) %>">
