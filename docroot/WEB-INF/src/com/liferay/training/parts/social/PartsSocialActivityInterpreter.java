...
public class PartsSocialActivityInterpreter extends
	...
	protected SocialActivityFeedEntry doInterpret(SocialActivity activity,
		...
		if (!permissionChecker.hasPermission(part.getGroupId(),
				Part.class.getName(), part.getPartId(), ActionKeys.VIEW)) {
			return null;
		}
	...
	protected String getTitle(SocialActivity activity, String key,
			String keyWithGroup, String content, String link,
			ThemeDisplay themeDisplay) {
		String userName = getUserName(activity.getUserId(), themeDisplay);
		String text = HtmlUtil.escape(StringUtil.shorten(HtmlUtil.extractText(content), 200));
		...
		return themeDisplay.translate(pattern, new Object[] { userName, text,
				groupName });
	}

	private static final String[] _CLASS_NAMES = new String[] { Part.class
			.getName() };
