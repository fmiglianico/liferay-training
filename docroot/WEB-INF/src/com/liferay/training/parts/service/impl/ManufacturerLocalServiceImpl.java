...
/**
 * The implementation of the manufacturer local service. <p> All custom service
 * methods should be put in this class. Whenever methods are added, rerun
 * ServiceBuilder to copy their definitions into the
 * {@link com.liferay.training.parts.service.ManufacturerLocalService}
 * interface. </p> <p> Never reference this interface directly. Always use
 * {@link com.liferay.training.parts.service.ManufacturerLocalServiceUtil} to
 * access the manufacturer local service. </p> <p> This is a local service.
...
public class ManufacturerLocalServiceImpl
	...
	public Manufacturer addManufacturer(
		Manufacturer newManufacturer, ServiceContext serviceContext)
		throws SystemException, PortalException {

		long manufacturerId =
			counterLocalService.increment(Manufacturer.class.getName());

		long userId = serviceContext.getUserId();
		User user = UserLocalServiceUtil.getUser(userId);

		Manufacturer manufacturer =
			manufacturerPersistence.create(manufacturerId);
		...
		manufacturerPersistence.update(manufacturer, false);

		resourceLocalService.addResources(
			manufacturer.getCompanyId(), manufacturer.getGroupId(), userId,
			Manufacturer.class.getName(), manufacturerId, false, true, true);
		assetEntryLocalService.updateEntry(
			userId, manufacturer.getGroupId(), Manufacturer.class.getName(),
		...
		WorkflowHandlerRegistryUtil.startWorkflowInstance(
			manufacturer.getCompanyId(), manufacturer.getGroupId(), userId,
			Manufacturer.class.getName(), manufacturer.getPrimaryKey(),
			manufacturer, serviceContext);
	...
	public Manufacturer deleteManufacturer(Manufacturer manufacturer)
		...
		resourceLocalService.deleteResource(
			manufacturer.getCompanyId(), Manufacturer.class.getName(),
			ResourceConstants.SCOPE_INDIVIDUAL, manufacturer.getPrimaryKey());
	...
	public Manufacturer updateManufacturer(
		Manufacturer editedManufacturer, ServiceContext serviceContext)
		throws SystemException, PortalException {

		Manufacturer manufacturer =
			super.updateManufacturer(editedManufacturer);
	...
	public List<Manufacturer> getManufacturersByGroupId(long groupId)
		...
		return manufacturerPersistence.filterFindByG_S(
	 ...
	 */
	public List<Manufacturer> getManufacturersByGroupId(
	...
	public int getManufacturersCountByGroupId(long groupId)
		...
		return manufacturerPersistence.filterCountByG_S(
			groupId, WorkflowConstants.STATUS_APPROVED);

	}

	public Manufacturer updateStatus(
		...
		if (status == WorkflowConstants.STATUS_APPROVED) {
			...
			assetEntryLocalService.updateVisible(
				Manufacturer.class.getName(), manufacturerId, true);
