...
import com.liferay.training.parts.NoSuchPurchaseOrderException;
...
public class PurchaseOrderPersistenceImpl extends BasePersistenceImpl<PurchaseOrder>
	 ...
	 */
	public PurchaseOrder create(long orderId) {
		PurchaseOrder purchaseOrder = new PurchaseOrderImpl();

		purchaseOrder.setNew(true);
		purchaseOrder.setPrimaryKey(orderId);
	 ...
	 */
	public PurchaseOrder remove(long orderId)
	...
	protected PurchaseOrder toUnwrappedModel(PurchaseOrder purchaseOrder) {
		...
		purchaseOrderImpl.setOrderId(purchaseOrder.getOrderId());
		purchaseOrderImpl.setCompanyId(purchaseOrder.getCompanyId());
		purchaseOrderImpl.setGroupId(purchaseOrder.getGroupId());
		purchaseOrderImpl.setPartId(purchaseOrder.getPartId());
		purchaseOrderImpl.setUserId(purchaseOrder.getUserId());
		purchaseOrderImpl.setOrderDate(purchaseOrder.getOrderDate());
		purchaseOrderImpl.setClosed(purchaseOrder.isClosed());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PurchaseOrder findByPrimaryKey(long orderId)
		throws NoSuchPurchaseOrderException, SystemException {
		PurchaseOrder purchaseOrder = fetchByPrimaryKey(orderId);
		...
		if (purchaseOrder == null) {
			...
			try {
				...
				if (purchaseOrder != null) {
					...
					EntityCacheUtil.putResult(PurchaseOrderModelImpl.ENTITY_CACHE_ENABLED,
						PurchaseOrderImpl.class, orderId, _nullPurchaseOrder);
				}
	...
	public List<PurchaseOrder> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_PURCHASEORDER.concat(PurchaseOrderModelImpl.ORDER_BY_JPQL);
			}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.training.parts.model.PurchaseOrder")));
