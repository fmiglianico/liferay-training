...
<liferay-ui:search-container
	...
	<liferay-ui:search-container-row
		...
		keyProperty="manufacturerId" modelVar="manufacturer" escapedModel="true" >
		...
		<liferay-ui:search-container-column-text name="name" href="<%=rowURL %>" 
			value="<%= manufacturer.getName() %>" />
 

		<liferay-ui:search-container-column-text name="email-address" href="<%=rowURL %>" 
			property="emailAddress" />

		<liferay-ui:search-container-column-text name="phone-number" href="<%=rowURL %>" 
			property="phoneNumber" />

		<liferay-ui:search-container-column-text name="website" href="<%=rowURL %>" 
			property="website" />
